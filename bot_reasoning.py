...
class BotCommandParser:
    ...
    Attributes:
        dice_roll_pattern (re.Pattern): A compiled regex pattern to match dice roll commands.
        dice_reroll_pattern (re.Pattern): A compiled regex pattern to match dice reroll commands.
        ROLL_REGEX (re.Pattern): A compiled regex pattern to match '/roll' command.
        REROLL_REGEX (re.Pattern): A compiled regex pattern to match '/reroll' command with hexadecimal value.
    """
    ...
    def __init__(self):
        """
        Initializes the BotCommandParser with a compiled regex pattern to match dice roll commands.
        """
